...
const Dashboard = ({ theme, toggleTheme }) => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-[#09100c] text-gray-900 dark:text-white font-inter flex overflow-hidden">
      
      {/* Side Navigation */}
      <aside className="w-64 border-r border-gray-200 dark:border-white/10 bg-white dark:bg-[#0e1511]/80 backdrop-blur-2xl flex flex-col fixed h-full z-40">
        <div className="p-8 flex items-center gap-3">
          <div className="w-10 h-10 bg-[#10b981] rounded-xl flex items-center justify-center shadow-lg shadow-emerald-500/20">
            <Bus className="text-gray-900 dark:text-white" size={24} />
          </div>
          <div>
        ...
        <div className="px-6 py-4">
          <div className="flex items-center gap-4 p-4 bg-gray-100 dark:bg-white/5 rounded-2xl border border-gray-200 dark:border-white/5 mb-8">
        ...
        <nav className="flex-1 px-4 space-y-2">
          {getSidebarLinks().map((item) => (
            <button 
              key={item.label}
              className={`w-full flex items-center gap-4 px-6 py-4 rounded-xl transition-all group ${item.active ? 'bg-[#10b981]/10 text-[#10b981] border-r-4 border-[#10b981]' : 'text-gray-500 dark:text-white/40 hover:bg-gray-100 dark:bg-white/5 hover:text-gray-900 dark:hover:text-white'}`}
            >
      ...
      <main className="flex-1 ml-64 min-h-screen relative">
        ...
        {/* Top Bar */}
        <header className="h-20 border-b border-gray-200 dark:border-white/10 flex items-center justify-between px-12 bg-gray-50 dark:bg-[#09100c]/80 backdrop-blur-xl sticky top-0 z-50">
          <div className="flex items-center gap-8 text-sm font-medium text-gray-500 dark:text-white/40">
            <button className="text-[#10b981] font-bold border-b-2 border-[#10b981] pb-1">Discover</button>
            <button className="hover:text-gray-900 dark:hover:text-white transition-colors">Routes</button>
            <button className="hover:text-gray-900 dark:hover:text-white transition-colors">Experience</button>
          </div>
          <div className="flex items-center gap-6">
<div className="flex items-center gap-4 mr-4">
              <span className="text-xs font-bold text-gray-500 dark:text-white/40 uppercase tracking-widest">Role:</span>
              <select 
                value={activeRole} 
            ...
            <button className="p-2 hover:bg-gray-100 dark:bg-white/5 rounded-full transition-colors relative">
              <Bell size={20} className="text-gray-600 dark:text-white/60" />
              <span className="absolute top-2 right-2 w-2 h-2 bg-[#10b981] rounded-full border-2 border-[#09100c]"></span>
            </button>
            <button className="p-2 hover:bg-gray-100 dark:bg-white/5 rounded-full transition-colors">
              <Settings size={20} className="text-gray-600 dark:text-white/60" />
            </button>
...
<div className="w-10 h-10 rounded-full overflow-hidden border border-gray-200 dark:border-white/10">
        ...
        <div className="p-12 max-w-7xl mx-auto space-y-12">
          ...
          <section className="relative h-[400px] rounded-3xl overflow-hidden group shadow-2xl">
            ...
            <div className="absolute bottom-8 left-1/2 -translate-x-1/2 w-[90%] bg-white dark:bg-[#0e1511]/90 backdrop-blur-2xl border border-gray-200 dark:border-white/10 rounded-2xl p-6 flex items-center gap-4 shadow-2xl">
              <div className="flex-1 grid grid-cols-3 gap-4">
                <div className="bg-gray-100 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-xl p-3 flex items-center gap-3">
                ...
                <div className="bg-gray-100 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-xl p-3 flex items-center gap-3 relative">
                  <button className="absolute -left-6 top-1/2 -translate-y-1/2 w-8 h-8 bg-[#10b981] rounded-full flex items-center justify-center text-gray-900 dark:text-white z-10 border-4 border-[#0e1511] hover:scale-110 transition-transform">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              {/* Ticket Card */}
              <div className="bg-white dark:bg-[#0e1511] border border-gray-200 dark:border-white/10 rounded-3xl p-8 relative overflow-hidden group">
                <div className="flex justify-between items-start mb-12">
                  <div className="flex gap-4">
                    <div className="w-12 h-12 bg-gray-100 dark:bg-white/5 rounded-xl flex items-center justify-center text-[#10b981]">
                      <Bus size={28} />
                    </div>
                    <div>
                      <h4 className="text-xl font-bold font-outfit">K-Swift Gaja</h4>
                      <p className="text-xs text-gray-500 dark:text-white/40">Volvo 9600 Multi-Axle Sleeper</p>
                    </div>
                  </div>
                  <div className="text-center p-6 bg-gray-100 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-2xl">
                    <p className="text-[10px] uppercase font-bold text-gray-500 dark:text-white/40 mb-1">Seat</p>
                    <p className="text-3xl font-bold text-[#10b981]">L4</p>
                    <p className="text-[10px] text-gray-500 dark:text-white/40">Lower Sleeper</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-8 relative">
                  <div className="flex-1 flex justify-between items-center relative">
                    <div className="text-center">
                      ...
                      <p className="text-xs text-gray-500 dark:text-white/40 mt-1">Bangalore</p>
                    </div>
                    
                    <div className="flex-1 flex flex-col items-center px-4 relative">
                      <div className="w-full h-[2px] bg-gray-200 dark:bg-white/10 relative">
                        <div className="absolute top-1/2 left-0 -translate-y-1/2 w-2 h-2 rounded-full bg-[#10b981]"></div>
                        <div className="absolute top-1/2 right-0 -translate-y-1/2 w-2 h-2 rounded-full bg-gray-300 dark:bg-white/20"></div>
                      ...
                      <p className="text-[8px] text-gray-400 dark:text-white/20 uppercase tracking-widest">Coimbatore</p>
                    </div>

                    <div className="text-center">
                      <p className="text-2xl font-bold opacity-40">07:45</p>
                      <p className="text-xs text-gray-400 dark:text-white/20 mt-1">Kochi</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              {/* Lounge Access Card */}
              <button className="w-full bg-white dark:bg-[#0e1511] border border-[#10b981]/30 rounded-2xl p-6 flex items-center justify-between group hover:border-[#10b981] transition-all">
                <div className="flex items-center gap-6">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-xs text-gray-500 dark:text-white/40 mt-1">Complimentary refreshments before your next trip.</p>
                  </div>
                </div>
                <ChevronRight className="text-gray-400 dark:text-white/20 group-hover:text-[#10b981] group-hover:translate-x-1 transition-all" />
              </button>
            </div>
            ...
            <div className="space-y-8">
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-white dark:bg-[#0e1511] border border-gray-200 dark:border-white/5 p-6 rounded-2xl hover:scale-[1.02] transition-transform">
                  <Star className="text-[#10b981] mb-4" size={20} />
                  <p className="text-2xl font-bold font-outfit">1,200</p>
                  <p className="text-[10px] text-gray-500 dark:text-white/40 uppercase font-bold tracking-wider">Loyalty Points</p>
                </div>
                <div className="bg-white dark:bg-[#0e1511] border border-gray-200 dark:border-white/5 p-6 rounded-2xl hover:scale-[1.02] transition-transform">
                  <Bus className="text-[#10b981] mb-4" size={20} />
                  <p className="text-2xl font-bold font-outfit">24</p>
                  <p className="text-[10px] text-gray-500 dark:text-white/40 uppercase font-bold tracking-wider">Total Trips</p>
                </div>
              </div>

              <div className="bg-white dark:bg-[#0e1511] border border-gray-200 dark:border-white/5 p-6 rounded-2xl flex items-center justify-between">
                <div>
                  <div className="flex items-center gap-2 mb-1">
                    <CreditCard size={14} className="text-[#10b981]" />
                    <p className="text-[10px] text-gray-500 dark:text-white/40 uppercase font-bold tracking-wider">Travel Credits</p>
                  </div>
                  <p className="text-2xl font-bold font-outfit">₹2,450</p>
                </div>
                <button className="px-4 py-2 bg-gray-100 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-lg text-xs font-bold hover:bg-[#10b981] hover:text-gray-900 dark:hover:text-white transition-all">
                  Redeem
                </button>
              </div>
              ...
              <div>
                <div className="flex justify-between items-center mb-6">
                  ...
                  <button className="text-[10px] text-gray-500 dark:text-white/40 font-bold hover:text-gray-900 dark:hover:text-white transition-colors uppercase tracking-widest">View All</button>
                </div>
                <div className="space-y-4">
                  {[
                    ...
                    <div key={i} className="bg-white dark:bg-[#0e1511] border border-gray-200 dark:border-white/5 p-5 rounded-2xl group hover:border-[#10b981]/30 transition-all cursor-pointer">
                      ...
                      <p className="text-[10px] text-gray-500 dark:text-white/40 font-medium">{trip.date} • {trip.type}</p>
                    </div>
                  ))}
                </div>
              </div>
            ...
            <div className="flex flex-col items-center justify-center h-[60vh] border border-gray-200 dark:border-white/5 bg-gray-100 dark:bg-white/5 rounded-3xl mt-12 w-full">
               <Settings size={48} className="text-[#10b981] mb-6 animate-spin-slow opacity-50" />
               <h3 className="text-2xl font-bold font-outfit text-gray-900 dark:text-white mb-2">Role specific widgets coming soon!</h3>
               <p className="text-gray-500 dark:text-white/40">You are currently viewing the {activeRole.toUpperCase()} layout.</p>
            </div>
          )}
        </div>
      </main>
